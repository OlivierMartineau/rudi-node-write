...
from rudi_node_write.connectors.io_rudi_catalog_write import RudiNodeCatalogConnector
...
def test_RudiNodeCatalogConnector():
    rudi_jwt_factory = RudiNodeJwtFactory(auth_url, auth=rudi_node_creds)
    rudi_api = RudiNodeCatalogConnector(url, jwt_factory=rudi_jwt_factory)
...
def test_RudiNodeCatalogConnector_metadata_count():
    metadata_count = rudi_api.metadata_count
    assert metadata_count > 0


def test_RudiNodeCatalogConnector_metadata_list():
...
def test_RudiNodeCatalogConnector_producers():
...
def test_RudiNodeCatalogConnector_get_or_create_org_with_info():
...
def test_RudiNodeCatalogConnector_contacts():
...
def test_RudiNodeCatalogConnector_thesauri():
...
def test_RudiNodeCatalogConnector_download_files_for_metadata():
...
def test_RudiNodeCatalogConnector_download_file_with_name():
