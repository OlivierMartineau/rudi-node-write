...
from rudi_node_write.utils.dict_utils import merge_dict_of_list, pick_in_dict, safe_get_key
...
from rudi_node_write.utils.typing_utils import check_type, get_type_name
...
class RudiNodeAuth:
    def __init__(self, b64url_auth: str | None = None, usr: str | None = None, pwd: str | None = None):
        """
        Initialize such object with either a `b64url_auth` URL-safe Base64 encoded `usr:pwd` string, or with a couple of `usr` and `pwd` strings.
        """
