...
class Connector:
    ...
    def test_connection(self) -> (str | dict):
        return self.request()
    ...
    def download(
        self, relative_url: str, headers: dict|None = None, keep_alive: bool = False, should_log_response: bool = False
    ):
        """
    ...
    def request(
        ...
        body: dict | str | BinaryIO | TextIO | None = None,
        headers=None,
