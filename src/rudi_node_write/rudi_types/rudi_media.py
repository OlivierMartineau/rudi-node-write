...
from rudi_node_write.utils.list_utils import check_is_list, check_is_list_or_none, is_list
...
class RudiMediaFile(RudiMedia):
    def __init__(
        ...
        file_storage_status: FileStorageStatus = "missing",
        file_status_update: str = Date.now_iso_str(),
        collection_tag: str | None = None,
    ):
        super().__init__(
            media_id=media_id,
        ...
        self.file_status_update = Date.from_str(file_status_update, is_none_accepted=True)
